  ...
  return (
    <section className={styles.new_collection}>
      ...
      <div className={styles.slogan}>
        <span className={styles.no_wrap}>Inspired by city explorers. </span>
        <span> </span>
        <span className={styles.no_wrap}>Made to move. </span>
        <span> </span>
        <span className={styles.no_wrap}>Built for tomorrow</span>
      </div>
      <ShopButton />
